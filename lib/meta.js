...
function Meta() {
  ...
  var blockSymbolDo = new meta.BlockData(
    ...
    function (expr) {
      blockSymbolBlock.combine(expr);
      if (expr.sym === meta.tupleSymbol) {
  ...
  function Compiler(r) {
    ...
    Expr.prototype.isRightAssociative = function () {
      if (this.sym === null) {
        ...
        return this.sym.isRightAssociative;
      }
    };
    ...
    Expr.prototype.contextExtensionThatTakesRightOperand = function (context) {
    ...
    Expr.prototype.combineOperands = function (context, previous, next) {
      ...
      var extension = this.contextExtensionThatTakesRightOperand(context);

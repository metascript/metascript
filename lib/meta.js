...
function Meta() {
  ...
  function Compiler(r, options) {
    ...
    Expr.prototype.newObjectLiteral = function () {
      var result = new Expr(meta.objectSymbol, null, [], null);
      result.takeLocationFrom(this);
      return result;
    };
    ...
    Expr.prototype.applyTransformer = function (
      ...
      while (true) {
        ...
        try {
          ...
          if (this.compiler.options.fullMacroErrors) {
            ...
            this.error('Error in symbol ' + transformerName + ': ' + e);
          }
        }
        if (typeof result === 'undefined') {
          if (applyFixers) {
          ...
          if (parent !== null) {
            ...
            if (typeof resultReceiver === 'function') {
              ...
              if (this === this.compiler.root) {
                this.compiler.root = result;
              } else {
...
Meta.prototype.compilerFromString = function (s, name) {
  return this.Compiler(this.StringReader(s, name));
};

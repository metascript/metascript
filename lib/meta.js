...
function Meta() {
  ...
  meta.ScopeMap = function (expr, scopeGetter, scopeTester, root, subordinateGetter) {
  ...
  meta.ScopeMap.prototype.get = function (key) {
    for (var current = this; current != null; current = current.parent()) {
      if (typeof current.values[key] !== 'undefined') return current.values[key];
    }
    return null;
  };
  ...
  function Compiler(r, options) {
    ...
    function Expr(sym, val, args, parent) {
      ...
      this.declarations = new meta.ScopeMap(
        ...
        function () {
          return this.expr.sym.symbolData.canHostDeclarations || this.expr.parent === null;
        },
        null
      );
      this.keyScope = new meta.ScopeMap(
        ...
        function () {
          return this.expr.isBlock() || this.expr.sym.symbolData.opensNewScope || this.expr.parent === null;
        },
        meta.KEY_ROOT_SCOPE,
        function (key) {
          if (this.expr.sym.symbolData.subordinate !== null) {
      ...
      this.varScope = new meta.ScopeMap(
        ...
        function () {
          return this.expr.sym.symbolData.opensNewScope || this.expr.parent === null;
        },
        meta.VAR_ROOT_SCOPE
      );
    ...
    Expr.prototype.resolve = function (vTagMap) {
      ...
      if (vTagMap !== null && this.sym.symbolData.opensNewScope) {
    ...
    Expr.prototype.toString = function () {
      return util.format('sym "%s", val "%s", loc %d:%d',
                         this.sym.id, this.val, this.loc.start.line, this.loc.start.column);
    };

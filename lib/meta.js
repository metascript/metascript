...
function Meta() {
  ...
  function Compiler(r, options) {
    ...
    Expr.prototype.newTuple = function () {
        ...
        switch (callee.getTag()) {
          ...
          case 'macro':
            if (lowerArg.isCall()) {
              ...
              var expandFunction = expand.asEvalFunction(['expr', 'meta'], false);
    ...
    Expr.prototype.postcombine = function (resultReceiver) {
      return this.applyTransformer('postcombine', 'postcombination', false, resultReceiver);
    };

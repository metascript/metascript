...
function Meta() {
  ...
  meta.codegenVTag = function (expr) {
    return meta.codegenIdentifier(expr.loc, expr.val.val);
  };
  ...
  meta.codegenVTagDeclaration = function (expr) {
    var name = expr.createCodegenTemporary(expr.val);
    expr.val = name;
    return meta.codegenIdentifier(expr.loc, expr.val);
  };

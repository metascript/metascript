...
function Meta() {
  ...
  meta.implicitSymbol = Object.create(meta.callSymbol);
  meta.implicitSymbol.symbolData = Object.create(meta.callSymbol.symbolData);
  meta.implicitSymbol.symbolData.arity = meta.arityBinaryRight;
  meta.implicitSymbol.symbolData.precedence = 'IMPLICIT';
  ...
  meta.KEY_ROOT_SCOPE.set('from', new meta.Symbol('from', 'builtin',
    new meta.SymbolData(meta.arityUnary, 'KEY', {
      checkArity: function (expr) {
        if (expr.argCount() === 1) {
  ...
  Compiler.prototype.es5Generators = function (jsAst, embedRuntime) {
      ...
      var GeneratorFinder = recast.Visitor.extend({
        visitFunctionExpression: function(node) {
          hasGenerators |= node.generator;
          return node;
        }
      });
      new GeneratorFinder().visit(jsAst)

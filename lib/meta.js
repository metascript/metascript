...
function Meta() {
  ...
  meta.mapHas = function (map, key) {
    return Object.prototype.hasOwnProperty.call(map, key);
  };
  meta.mapGet = function (map, key) {
    return this.mapHas(map, key) ? map[key] : null;
  };
  meta.newMap = function () {
    return Object.create(null);
  };
  meta.addAllToMap = function (map, keys, value) {
    if (typeof value === 'undefined') { value = true; }
    for (var i = 0; i < keys.length; i++) {
      map[keys[i]] = value;
    }
  };
  meta.addAllObjectsToMap = function (map, key, values) {
    for (var i = 0; i < values.length; i++) {
      map[key(values[i])] = values[i];
    }
  };

  meta.RESERVED = meta.newMap();
  meta.PRIMITIVES = meta.newMap();
  meta.ROOT_SCOPE = meta.newMap();
  ...
  meta.PRIMITIVES.value = new meta.Symbol('<val>', 'builtin');
  meta.PRIMITIVES.operator = new meta.Symbol('<op>', 'builtin');
  meta.PRIMITIVES.identifier = new meta.Symbol('<id>', 'builtin');
  meta.PRIMITIVES.none = new meta.Symbol('<none>', 'builtin');
  meta.PRIMITIVES.par = new meta.Symbol('()', 'block', undefined,
                                   null, null, blockSymbolPar);
  meta.PRIMITIVES.square = new meta.Symbol('[]', 'block', undefined,
                                      null, null, blockSymbolSquare);
  meta.PRIMITIVES.curly = new meta.Symbol('{}', 'block', undefined,
                                     null, null, block_symbol_curly);
  meta.PRIMITIVES.block = new meta.Symbol('<block>', 'block', undefined,
                                     null, null, blockSymbolBlock);
  meta.PRIMITIVES.doblock = new meta.Symbol('<do>', 'block', undefined,
                                     null, null, blockSymbolDo);
  meta.PRIMITIVES.line = new meta.Symbol('<line>', 'block', undefined,
                                     null, null, blockSymbolLine);
  meta.PRIMITIVES.comma = new meta.Symbol('<comma>', 'block', undefined,
                                     null, null, blockSymbolComma);
  meta.PRIMITIVES['<val>'] = meta.PRIMITIVES.value;
  meta.PRIMITIVES['<op>'] = meta.PRIMITIVES.operator;
  meta.PRIMITIVES['<id>'] = meta.PRIMITIVES.identifier;
  meta.PRIMITIVES['<none>'] = meta.PRIMITIVES.none;
  meta.PRIMITIVES['()'] = meta.PRIMITIVES.par;
  meta.PRIMITIVES['[]'] = meta.PRIMITIVES.square;
  meta.PRIMITIVES['{}'] = meta.PRIMITIVES.curly;
  meta.PRIMITIVES['<block>'] = meta.PRIMITIVES.block;
  meta.PRIMITIVES['<do>'] = meta.PRIMITIVES.doblock;
  meta.PRIMITIVES['<line>'] = meta.PRIMITIVES.line;
  meta.PRIMITIVES['<comma>'] = meta.PRIMITIVES.comma;

  meta.addAllObjectsToMap(meta.ROOT_SCOPE, function (s) {
    return s.id;
  }, [
    meta.PRIMITIVES.value,
    meta.PRIMITIVES.operator,
    meta.PRIMITIVES.identifier,
    meta.PRIMITIVES.none,
    meta.PRIMITIVES.par,
    meta.PRIMITIVES.square,
    meta.PRIMITIVES.curly,
    meta.PRIMITIVES.block,
    meta.PRIMITIVES.line,
    meta.PRIMITIVES.comma
  ]);
  // More root scope filling...


  meta.addAllToMap(meta.RESERVED, [
  ...
  meta.Parser.prototype.isReserved = function (s) {
    return meta.mapHas(meta.RESERVED, s);
  };
  meta.Parser.prototype.isBlock = function (s) {
    return meta.mapHas(meta.PRIMITIVES, s) && meta.PRIMITIVES[s].blockData !== null;
  };
  meta.Parser.prototype.isBlockWithNewScope = function (s) {
    return this.isBlock(s) && meta.PRIMITIVES[s].blockData.needsNewScope;
  };

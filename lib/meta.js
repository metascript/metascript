...
function Meta() {
  ...
  Compiler.prototype.parseDone = function () {
  ...
  Compiler.prototype.generate = function (jsAst, escodegenOptions) {
    escodegenOptions = escodegenOptions || this.options.escodegenOptions || {};
  ...
  Compiler.prototype.compile = function (jsAst, options) {
    ...
    try {
      ...
      var generated = this.generate(jsAst, options.escodegenOptions);
...
Meta.prototype.createCompiler = function (reader, options) {
  return this.Compiler(reader, options);
};

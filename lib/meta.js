...
function Meta() {
  ...
  meta.addArity = function (needsLeft, canHaveLeft, needsRight,
        canHaveRight, minOperandCount, maxOperandCount,
  ...
  meta.addArity(false, false, false, false, 0, 0, false, true,  'aritySequence',      'sequence');
  meta.addArity(false, false, true,  true,  2, 2, true,  false, 'arityBinaryKeyword', 'binaryKeyword');
  meta.addArity(false, false, false, false, 0, 0, false, false, 'arityZero',          'zero');
  meta.addArity(false, false, false, true,  0, 1, true,  false, 'arityOptional',      'optional');
  meta.addArity(false, false, true,  true,  1, 1, true,  false, 'arityUnary',         'unary');
  meta.addArity(true,  true,  true,  true,  2, 2, false, false, 'arityBinary',        'binary');
  meta.addArity(true,  true,  true,  true,  2, 2, true,  false, 'arityBinaryRight',   'binaryRight');
  meta.addArity(true,  true,  false, false, 1, 1, false, false, 'arityPostfix',       'post');

  meta.addArity(false, true,  true,  true,  1, 2, false, false, 'aritySum',           '<sum>');
  meta.addArity(false, true,  false, true,  1, 1, false, false, 'arityIncrement',     '<inc>');
  meta.addArity(false, false, true,  true,  1, 1, true,  false, 'arityPreIncrement',  '<preinc>');
  meta.addArity(true,  true,  false, false, 1, 1, false, false, 'arityPostIncrement', '<postinc>');

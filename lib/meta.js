...
function Meta() {
  ...
  Compiler.prototype.compile = function () {
    ...
    try {
      var escodegenOptions = this.options.escodegen;
      if (typeof this.options.escodegen === 'undefined') {
        escodegenOptions = {};
      }
      ...
      var js = escodegenOptions.sourceMapWithCode ? generated.code : generated;

      if (typeof this.options.output !== 'undefined') {
        try {
          fs.writeFileSync(this.options.output, js);
        } catch (e) {
      ...
      if (map !== null) {
        try {
          fs.writeFileSync(this.options.map, map);
        } catch (e) {
